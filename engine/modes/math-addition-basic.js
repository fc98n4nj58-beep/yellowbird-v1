...
function buildUniquePairs(aPool, bPool) {
  const pairs = [];
...
function generate(params = {}) {
  ...
  const pool = buildUniquePairs(aPool, bPool);
  if (!pool.length) {
  ...
  // no duplicates until pool exhausted; then repeats after reshuffle
